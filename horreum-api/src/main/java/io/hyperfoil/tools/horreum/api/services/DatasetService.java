...
public interface DatasetService {
    ...
    Dataset getDataset(@PathParam("id")
    int datasetId);
    ...
    DatasetList listByTest(@PathParam("testId")
    int testId,
            @QueryParam("filter")
            String filter,
            @QueryParam("limit")
    ...
    DatasetList listBySchema(@QueryParam("uri")
    String uri,
            @QueryParam("limit")
            Integer limit,
            @QueryParam("page")
    ...
    List<LabelValue> labelValues(@PathParam("datasetId")
    int datasetId);

    @POST
    @Path("{datasetId}/previewLabel")
    LabelPreview previewLabel(@PathParam("datasetId")
    int datasetId, @RequestBody(required = true)
    Label label);

    @GET
    @Path("{datasetId}/summary")
    DatasetSummary getSummary(@PathParam("datasetId")
    int datasetId, @QueryParam("viewId")
    int viewId);
