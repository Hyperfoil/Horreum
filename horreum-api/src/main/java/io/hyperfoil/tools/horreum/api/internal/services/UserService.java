...
public interface UserService {
    ...
    @Path("info")
    @Blocking
    List<UserData> info(@RequestBody(required = true)
    List<String> usernames);

    @POST
    @Path("createUser")
    @Blocking
    void createUser(@RequestBody(required = true)
    NewUser user);

    @DELETE
    @Path("{username}")
    @Blocking
    void removeUser(@PathParam("username")
    String username);
    ...
    @Consumes("text/plain")
    @Blocking
    void setDefaultTeam(@RequestBody(required = true)
    String team);

    @GET
    @Path("team/{team}/members")
    @Blocking
    Map<String, List<String>> teamMembers(@PathParam("team")
    String team);

    @POST
    @Path("team/{team}/members")
    @Blocking
    void updateTeamMembers(@PathParam("team")
    String team, @RequestBody(required = true)
    ...
    @POST
    @Blocking
    void addTeam(@PathParam("team")
    String team);

    @Path("team/{team}")
    @DELETE
    @Blocking
    void deleteTeam(@PathParam("team")
    String team);
    ...
    @Path("administrators")
    @Blocking
    void updateAdministrators(@RequestBody(required = true)
    List<String> administrators);

    @GET
    @Path("team/{team}/machine")
    @Blocking
    List<UserData> machineAccounts(@PathParam("team")
    String team);
    ...
    @Produces("text/plain")
    @Blocking
    String resetPassword(@PathParam("team")
    String team, @RequestBody(required = true)
    String username);
