...
public interface LogService {
    ...
    List<DatasetLog> getDatasetLog(@PathParam("source")
    String source,
            @PathParam("testId")
            int testId,
            @QueryParam("level")
    ...
    long getDatasetLogCount(@PathParam("source")
    String source,
            @PathParam("testId")
            int testId,
            @QueryParam("level")
    ...
    @DELETE
    @Path("dataset/{source}/{testId}")
    void deleteDatasetLogs(@PathParam("source")
    String source,
            @PathParam("testId")
            int testId,
            @QueryParam("datasetId")
    ...
    List<TransformationLog> getTransformationLog(@PathParam("testId")
    int testId,
            @QueryParam("level")
            @DefaultValue("1")
            int level,
    ...
    long getTransformationLogCount(@PathParam("testId")
    int testId,
            @QueryParam("level")
            @DefaultValue("1")
            int level,
    ...
    @DELETE
    @Path("transformation/{testId}")
    void deleteTransformationLogs(@PathParam("testId")
    int testId,
            @QueryParam("runId")
            Integer runId,
            @QueryParam("from")
    ...
    @GET
    @Path("action/{testId}")
    List<ActionLog> getActionLog(@PathParam("testId")
    int testId,
            @QueryParam("level")
            @DefaultValue("1")
            int level,
    ...
    long getActionLogCount(@PathParam("testId")
    int testId,
            @QueryParam("level")
            @DefaultValue("1")
            int level
    ...
    @DELETE
    @Path("action/{testId}")
    void deleteActionLogs(@PathParam("testId")
    int testId,
            @QueryParam("from")
            Long from,
            @QueryParam("to")
