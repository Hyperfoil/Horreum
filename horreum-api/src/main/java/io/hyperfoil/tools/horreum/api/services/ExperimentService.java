...
public interface ExperimentService {
    ...
    Collection<ExperimentProfile> profiles(@PathParam("testId")
    int testId);
    ...
    int addOrUpdateProfile(@PathParam("testId")
    int testId,
    ...
    void deleteProfile(@PathParam("testId")
    int testId,
            @PathParam("profileId")
            int profileId
    );
                            ...
                            content = {
                                    @Content(
                                            schema = @Schema(
                                                    ...
                                                    implementation = ExperimentResult.class
                                            )
                                    )
                            }
                    )
    ...
    List<ExperimentResult> runExperiments(@QueryParam("datasetId")
    int datasetId);
    ...
    class ComparisonResult {
        @Schema(
                ...
                type = SchemaType.STRING,
                implementation = BetterOrWorse.class,
                allOf = BetterOrWorse.class
        )
