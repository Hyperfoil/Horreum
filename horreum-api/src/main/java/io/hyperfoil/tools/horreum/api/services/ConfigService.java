...
public interface ConfigService {
    ...
    @APIResponseSchema(value = Integer.class, responseDescription = "The ID for the new Datastore", responseCode = "200")
    ...
    @Consumes(APPLICATION_JSON)
    @APIResponseSchema(value = Integer.class, responseDescription = "The ID of the updated Datastore", responseCode = "200")
