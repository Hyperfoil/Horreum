...
public class Schema extends ProtectedType {
    ...
    public Integer id;
    @NotNull
    @org.eclipse.microprofile.openapi.annotations.media.Schema(required = true, description = "Unique, versioned schema URI", example = "uri:my-schema:0.1")
    @JsonProperty(required = true)
    public String uri;
    @NotNull
    ...
    @JsonProperty(required = true)
    public String name;
    @org.eclipse.microprofile.openapi.annotations.media.Schema(description = "Schema Description", example = "Schema for processing my benchmark")
    public String description;
    @org.eclipse.microprofile.openapi.annotations.media.Schema(implementation = String.class, description = "JSON validation schema. Used to validate uploaded JSON documents", example = "{"
            +
