...
public interface RunService {
    ...
    RunExtended getRun(@PathParam("id")
    int id,
            @QueryParam("token")
            String token
    );
    ...
    RunSummary getRunSummary(@PathParam("id")
    ...
    Object getData(@PathParam("id")
    int id,
            @QueryParam("token")
            String token,
            @QueryParam("schemaUri")
            String schemaUri
    );
    ...
    Object getMetadata(@PathParam("id")
    int id,
            @QueryParam("token")
            String token,
            @QueryParam("schemaUri")
    ...
    String resetToken(@PathParam("id")
    int id);
    ...
    Response addRunFromData(@QueryParam("start")
    String start,
            @QueryParam("stop")
            String stop,
            @QueryParam("test")
    ...
    @Operation(
            description = "Upload a new Run with metadata",
            hidden = true
    )
    @APIResponses(value = {
            @APIResponse(
    ...
    Response addRunFromData(
            ...
            @QueryParam("access")
            Access access,
            @Parameter(description = "Horreum internal token. Incompatible with Keycloak")
            @QueryParam("token")
            String token,
            @QueryParam("schema")
            String schemaUri,
    ...
    RunsSummary listAllRuns(@QueryParam("query")
    String query,
            @QueryParam("matchAll")
            boolean matchAll,
            @QueryParam("roles")
    ...
    RunCount runCount(@QueryParam("testId")
    int testId);
    ...
    RunsSummary listTestRuns(@PathParam("testId")
    int testId,
            @QueryParam("trashed")
            boolean trashed,
            @QueryParam("limit")
    ...
    RunsSummary listBySchema(@QueryParam("uri")
    String uri,
            @QueryParam("limit")
            Integer limit,
            @QueryParam("page")
    ...
    void trash(@PathParam("id")
    int id, @QueryParam("isTrashed")
    Boolean isTrashed);
    ...
    void updateDescription(@PathParam("id")
    int id, @RequestBody(required = true)
    String description);
...
//           }
//   )
    Map<Integer, String> updateSchema(@PathParam("id")
    int id,
            @QueryParam("path")
            String path,
            @RequestBody(required = true)
    ...
    List<Integer> recalculateDatasets(@PathParam("id")
    int runId);
    ...
    void recalculateAll(@QueryParam("from")
    String from, @QueryParam("to")
    String to);

    @Schema(
            type = SchemaType.OBJECT,
            allOf = ProtectedTimeType.class
    )
    ...
    @JsonIgnoreProperties({
            "token", "old_start"
    }) //ignore properties that have not been mapped
