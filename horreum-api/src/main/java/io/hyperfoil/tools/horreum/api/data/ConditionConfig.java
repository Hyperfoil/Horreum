...
public class ConditionConfig {
    ...
    @Schema(
            ...
            example = ChangeDetectionModelType.names.FIXED_THRESHOLD
    )
    public String name;
    @NotNull
    @Schema(
    ...
    public class Component {
        ...
        @Schema(
                type = SchemaType.OBJECT,
                implementation = ComponentType.class,
    ...
    public static class LogSliderComponent implements ComponentTemplate {
        ...
        @Override
        public ComponentType getType() { return ComponentType.LOG_SLIDER; }

        @Override
        public JsonNode getDefault() { return JsonNodeFactory.instance.numberNode(defaultValue); }
    ...
    public static class EnumComponent implements ComponentTemplate {
        ...
        @Override
        public ComponentType getType() { return ComponentType.ENUM; }

        @Override
        public JsonNode getDefault() { return JsonNodeFactory.instance.textNode(defaultValue); }
    ...
    public static class NumberBound implements ComponentTemplate {
        @Override
        public ComponentType getType() { return ComponentType.NUMBER_BOUND; }
    ...
    public static class SwitchComponent implements ComponentTemplate {
        @Override
        public ComponentType getType() { return ComponentType.SWITCH; }

        @Override
        public JsonNode getDefault() { return JsonNodeFactory.instance.booleanNode(true); }
