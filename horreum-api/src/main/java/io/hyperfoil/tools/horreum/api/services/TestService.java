...
public interface TestService {
    ...
    @APIResponses(value = {
            @APIResponse(responseCode = "200", description = "List of all folders", content = {
                    @Content(schema = @Schema(type = SchemaType.ARRAY, implementation = String.class), example = "[ \"quarkus\", \"ocp-perf-team\"] ")
            })
    })
    ...
    @APIResponses(value = { @APIResponse(responseCode = "200", content = {
            @Content(schema = @Schema(type = SchemaType.ARRAY, implementation = Object.class)) }) })
    Map<String, String[]> filteringLabels(@PathParam("id") int testId);
    ...
    class TestSummary extends ProtectedType {
        ...
        @Schema(description = "Total number of Datasets for the Test", example = "202")
        public Number datasets;
        @Schema(description = "Total number of Runs for the Test", example = "101")
        public Number runs;

        @Schema(description = "Subscriptions for each test for authenticated user", example = "[]")
    ...
    class TestQueryResult {
        ...
        @Schema(description = "Count of available tests. This is a count of tests that the current user has access to", example = "64")
        @JsonProperty(required = true)
        public long count;
