...
public interface SchemaService {
    ...
    SchemaQueryResult list(@QueryParam("roles")
    String roles,
            @QueryParam("limit")
            Integer limit,
            @QueryParam("page")
    ...
    List<LabelLocation> findUsages(@QueryParam("label")
    String label);
    ...
    List<Transformer> listTransformers(@PathParam("schemaId")
    int schemaId);
    ...
    int addOrUpdateTransformer(@PathParam("schemaId")
    int schemaId,
    ...
    void deleteTransformer(@PathParam("schemaId")
    int schemaId, @PathParam("transformerId")
    int transformerId);
    ...
    List<Label> labels(@PathParam("schemaId")
    int schemaId);
    ...
    Integer addOrUpdateLabel(@PathParam("schemaId")
    int schemaId, @RequestBody(required = true)
    Label label);
    ...
    void deleteLabel(@PathParam("schemaId")
    int schemaId, @PathParam("labelId")
    int labelId);
    ...
    Collection<LabelInfo> allLabels(@QueryParam("name")
    String name);
    ...
    @RequestBody(
            ...
            content = @Content(
                    ...
                    schema = @org.eclipse.microprofile.openapi.annotations.media.Schema(
                            implementation = SchemaExport.class
                    )
            )
    )
    @Operation(
            description = "Import an previously exported Schema either as a new Schema or to update an existing Schema"
    )
