...
@Schema(
        ...
        allOf = {
                ProtectedType.class, ProtectedTimeType.class
        },
...
public class Dataset extends ProtectedTimeType {
    ...
    @JsonIgnore
    public Info getInfo() { return new Info(this.id, this.runId, this.ordinal, this.testid); }
    ...
    public static class Info {
        ...
        public boolean equals(Object o) {
            if (this == o) {
                ...
                Info info = (Info) o;
                return this.id == info.id && this.runId == info.runId && this.ordinal == info.ordinal && this.testId ==
                        info.testId;
            } else {
                return false;
            }
        ...
        public int hashCode() {
            return Objects.hash(new Object[]{
                    this.id, this.runId, this.ordinal, this.testId
            });
        }
