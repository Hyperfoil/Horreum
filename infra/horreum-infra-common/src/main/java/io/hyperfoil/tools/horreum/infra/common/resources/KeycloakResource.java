    ...
    public void init(Map<String, String> initArgs) {
        ...
        if (startDevService) {
            ...
            if (initArgs.containsKey(HORREUM_DEV_KEYCLOAK_HTTPS_CERTIFICATE) && initArgs.containsKey(HORREUM_DEV_KEYCLOAK_HTTPS_CERTIFICATE_KEY)) {
                keycloakContainer.withCopyToContainer(Transferable.of(initArgs.get(HORREUM_DEV_KEYCLOAK_HTTPS_CERTIFICATE)), "/tmp/keycloak-tls.crt");
                keycloakContainer.addEnv("KC_HTTPS_CERTIFICATE_FILE", "/tmp/keycloak-tls.crt");
                keycloakContainer.withCopyToContainer(Transferable.of(initArgs.get(HORREUM_DEV_KEYCLOAK_HTTPS_CERTIFICATE_KEY)), "/tmp/keycloak-tls.key");
