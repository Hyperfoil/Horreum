...
export default function TestView() {
    ...
    const generalFuncsRef = useRef<TabFunctions>(undefined)
    const viewFuncsRef = useRef<TabFunctions>(undefined)
    const variablesFuncsRef = useRef<TabFunctions>(undefined)
    const missingDataFuncsRef = useRef<TabFunctions>(undefined)
    const experimentsFuncsRef = useRef<TabFunctions>(undefined)
    const actionsFuncsRef = useRef<TabFunctions>(undefined)
