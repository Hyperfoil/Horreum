...
/**
 * Extends {@link KeycloakTestResourceLifecycleManager} so that the service client has
 *
 * <pre>
 * realm - admin
 * </pre>
 *
 * role to be able to manage users in the realm
 */
public class HorreumKeycloakTestResourceLifecycleManager extends KeycloakTestResourceLifecycleManager {
    ...
    public Map<String, String> start() {
        ...
        try (Keycloak keycloak = KeycloakBuilder.builder()
            ...
            RoleScopeResource managementRolesResource = realmResource.users().get(serviceAccountId).roles()
