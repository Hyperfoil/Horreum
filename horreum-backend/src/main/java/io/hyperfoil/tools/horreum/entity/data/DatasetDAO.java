...
public class DatasetDAO extends OwnedEntityBase {
    ...
    public int getRunId() { return run.id; }

    public void setRunId(int runId) { run = getEntityManager().getReference(RunDAO.class, runId); }
    ...
    public DatasetDAO.Info getInfo() { return new DatasetDAO.Info(id, run.id, ordinal, testid); }
