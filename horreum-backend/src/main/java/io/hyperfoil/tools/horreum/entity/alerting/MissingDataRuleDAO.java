...
public class MissingDataRuleDAO extends PanacheEntityBase {
    ...
    public void setTestId(int testId) { this.test = TestDAO.getEntityManager()
            .getReference(TestDAO.class, testId); }
    ...
    public boolean equals(Object o) {
        ...
        return maxStaleness == that.maxStaleness && Objects.equals(labels, that.labels) && Objects.equals(
                condition,
                that.condition
        );
    }
