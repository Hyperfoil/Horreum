...
public class ExperimentProfileMapper {
    ...
    public static ExperimentProfile from(ExperimentProfileDAO ep) {
        ...
        dto.comparisons = ep.comparisons.stream()
                .map(ExperimentProfileMapper::fromExperimentComparison)
    ...
    public static ExperimentProfileDAO to(ExperimentProfile dto) {
        ...
        ep.comparisons = dto.comparisons.stream()
                .map(ExperimentProfileMapper::toExperimentComparison)
                .collect(Collectors.toList());
