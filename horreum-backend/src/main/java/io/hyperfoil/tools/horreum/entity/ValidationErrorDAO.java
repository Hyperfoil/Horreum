...
public class ValidationErrorDAO {
    ...
    public void setSchema(int id) { schema = SchemaDAO.getEntityManager()
            .getReference(SchemaDAO.class, id); }

    public Integer getSchemaId() { return schema == null ? null : schema.id; }
