...
public interface RunService {
    ...
    int id, @QueryParam("token")
    String token, @QueryParam("schemaUri")
    String schemaUri);
...
//                         @QueryParam("array") @DefaultValue("false") boolean array);
    ...
    @GET
    @Path("autocomplete")
    List<String> autocomplete(@QueryParam("query")
    String query);
    ...
    int id, @QueryParam("path")
    String path, String schemaUri);
