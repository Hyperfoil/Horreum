...
if [ "$CONTAINER_RUNTIME" = "podman" ]; then
  echo "QUARKUS_DATASOURCE_URL=jdbc:postgresql://127.0.0.1:5432/horreum" >> /etc/horreum/cwd/.env
  echo "QUARKUS_DATASOURCE_MIGRATION_URL=jdbc:postgresql://127.0.0.1:5432/horreum" >> /etc/horreum/cwd/.env
