                ...
                return (
                    <Button
                        ...
                        onClick={() => {
                            ...
                            removePrefix(value).catch(e => dispatch(alertAction('REMOVE_HOOK_PREFIX', "Failed to remove hook prefix.", e)))
                        }}>
                        <OutlinedTimesCircleIcon/>
                    </Button>
                )
        ...
        <Card>
            <CardHeader>
                <AddPrefixModal
                    ...
                    onSubmit={ prefix => addPrefix(prefix).then(
                ...
                <Toolbar className="pf-l-toolbar pf-u-justify-content-space-between pf-u-mx-xl pf-u-my-md" style={{ justifyContent: "space-between"}}>
                    <ToolbarContent>
                        <ToolbarItem aria-label="info">
                            <Button onClick={ () => setOpen(true) }><PlusIcon/> Add Prefix</Button>
                        </ToolbarItem>
                    </ToolbarContent>
                </Toolbar>
            </CardHeader>
            <CardBody>
                { !prefixes && <Bullseye><Spinner size="xl" /></Bullseye> }
