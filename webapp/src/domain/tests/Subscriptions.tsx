...
export default function Subscriptions(props: SubscriptionsProps) {
    ...
    const [isCheckedMissingRuns, setIsCheckedMissingRuns] = useState(props.missingruns == true)
    ...
    useEffect(() => {
        ...
        dispatch(getSubscription(props.testId)).then(watch => {
            ...
            setIsCheckedMissingRuns(watch.missingruns)
        }, noop)
        teams().then(
        ...
        save: () =>
            dispatch(
                updateSubscription({
                    ...
                    missingruns: isCheckedMissingRuns,
                })
            ),
        ...
        <>
            ...
            <Switch
                onChange={(checked, ev) => {
                    ...
                    props.onModified(false)
                }}
                isChecked={isCheckedMissingRuns}
                label="Missing run notifications enabled"
                labelOff="Missing run run notifications disabled"
                id="switchmissingruns"
            />
        </>
    )
}
