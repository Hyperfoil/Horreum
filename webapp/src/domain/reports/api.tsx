...
const endPoints = {
    tableReports: (pagination: PaginationInfo, testid?: number, roles?: string) => `${base}/table?${ testid !== undefined ? `test=${ testid }&` : ""}${ roles ? `owner=${encodeURIComponent(roles)}&`: "" }${ paginationParams(pagination)}`,
